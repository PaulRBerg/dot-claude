...
The `settings.json` file is automatically generated from modular JSONC source files in this directory. **Do not edit `settings.json` directly** - your changes will be overwritten.
