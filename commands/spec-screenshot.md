---
argument-hint: [OUTPUT_PATH="<output path>"]
...
- Target output: !`test -f DESCRIPTION.md && echo "DESCRIPTION.md exists (will be overwritten)" || echo "Will create new DESCRIPTION.md"`
...
### STEP 3: Generate comprehensive DESCRIPTION.md

DETERMINE output path:
- IF `$ARGUMENTS` provided: USE as custom output path (e.g., `./docs/spec.md`)
- ELSE: USE default `./DESCRIPTION.md`

**Content structure for DESCRIPTION.md:**
...
3. Review DESCRIPTION.md for comprehensive breakdown
```
...
- **Overwrite behavior**: Running command multiple times will overwrite existing DESCRIPTION.md
