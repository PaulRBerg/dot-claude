...
Activate the `yeet` skill to create an issue in `vercel-labs/skills` Github repository. Follow the workflow in `~/.agents/skills/yeet/references/issue-skills-cli.md`.
